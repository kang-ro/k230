...
# -------------------------------
threshold = [123, 145, 48, 79, 44, 73]  # 颜色阈值 [Rmin, Rmax, Gmin, Gmax, Bmin, Bmax]
...
roi_width_real = 3.7     # 例如：色块宽 3cm / Blob width in real world
roi_height_real = 3.7    # 例如：色块高 2.8cm / Blob height in real world
