# -*- coding: utf-8 -*-
'''
注:本章所有代码均为嘉楠提供的示例程序, 不能直接运行在Yahboom K230上, 仅做参考例程模板提供
Note: All the code in this chapter is provided as example programs by Canaan, and cannot be directly run on the Yahboom K230 board. It is only provided as a reference template.
'''
'''
